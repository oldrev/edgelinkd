...
| :white_check_mark: | ~~inject node should report invalid JSONata expression~~ |
...
| :white_check_mark: | ~~switch Node should take head of message sequence (w. JSONata)~~ |
...
| :white_check_mark: | ~~change Node #set changes the value using flow context with jsonata~~ |
| :white_check_mark: | ~~change Node #set changes the value using global context with jsonata~~ |
| :white_check_mark: | ~~change Node #set changes the value using jsonata~~ |
| :white_check_mark: | ~~change Node #set changes the value using persistable flow context with jsonata~~ |
| :white_check_mark: | ~~change Node #set changes the value using persistable global context with jsonata~~ |
...
| :white_check_mark: | ~~change Node #set reports invalid jsonata expression~~ |
...
| :white_check_mark: | ~~trigger node should be able to return things from flow and global context variables~~ |
...
| :white_check_mark: | ~~trigger node should ignore msg.delay if overrideDelay not set~~ |
| :white_check_mark: | ~~trigger node should output 1 then 0 when triggered (default)~~ |
| :white_check_mark: | ~~trigger node should output 1st value when triggered (bin)~~ |
| :white_check_mark: | ~~trigger node should output 1st value when triggered (bool)~~ |
| :white_check_mark: | ~~trigger node should output 1st value when triggered (date)~~ |
| :white_check_mark: | ~~trigger node should output 1st value when triggered (date)~~ |
| :white_check_mark: | ~~trigger node should output 1st value when triggered (env)~~ |
...
| :white_check_mark: | ~~trigger node should output 2st value when triggered (bin)~~ |
| :white_check_mark: | ~~trigger node should output 2st value when triggered (bool)~~ |
| :white_check_mark: | ~~trigger node should output 2st value when triggered (date)~~ |
| :white_check_mark: | ~~trigger node should output 2st value when triggered (date)~~ |
| :white_check_mark: | ~~trigger node should output 2st value when triggered (env)~~ |
...
| :white_check_mark: | ~~trigger node should use msg.delay if overrideDelay is set~~ |
...
| Status | Spec Test |
| --- | --- |
| :white_check_mark: | ~~JOIN node messaging API should call done() regardless of buffer overflow~~ |
| :white_check_mark: | ~~JOIN node messaging API should call done() when all messages are joined~~ |
| :white_check_mark: | ~~JOIN node messaging API should call done() when all messages are reduced~~ |
| :white_check_mark: | ~~JOIN node messaging API should call done() when consolidated message is emitted (Buffer, bin)~~ |
| :white_check_mark: | ~~JOIN node messaging API should call done() when consolidated message is emitted (Buffer, len)~~ |
| :white_check_mark: | ~~JOIN node messaging API should call done() when consolidated message is emitted (Buffer, str)~~ |
| :white_check_mark: | ~~JOIN node messaging API should call done() when consolidated message is emitted (string, len)~~ |
| :white_check_mark: | ~~JOIN node messaging API should call done() when message is sent (array)~~ |
| :white_check_mark: | ~~JOIN node messaging API should call done() when message is sent (object)~~ |
| :white_check_mark: | ~~JOIN node messaging API should call done() when message is sent (string)~~ |
| :white_check_mark: | ~~JOIN node messaging API should call done() when the node is reset~~ |
| :white_check_mark: | ~~JOIN node messaging API should call done() when timed out~~ |
| :white_check_mark: | ~~JOIN node should accumulate a key/value object~~ |
| :white_check_mark: | ~~JOIN node should accumulate a merged object~~ |
| :white_check_mark: | ~~JOIN node should allow chained split-split-join-join sequences~~ |
| :white_check_mark: | ~~JOIN node should allow the timeout to be restarted~~ |
| :white_check_mark: | ~~JOIN node should be able to reset an accumulation~~ |
| :white_check_mark: | ~~JOIN node should be loaded~~ |
| :white_check_mark: | ~~JOIN node should concat payload when group.type is array~~ |
| :white_check_mark: | ~~JOIN node should concat payload when group.type is buffer and group.joinChar is undefined~~ |
| :white_check_mark: | ~~JOIN node should concat payload when group.type is string and group.joinChar is not string~~ |
| :white_check_mark: | ~~JOIN node should handle invalid JSONata fixup expression - runtime err"~~ |
| :white_check_mark: | ~~JOIN node should handle invalid JSONata fixup expression - syntax err"~~ |
| :white_check_mark: | ~~JOIN node should handle invalid JSONata reduce expression - runtime error"~~ |
| :white_check_mark: | ~~JOIN node should handle invalid JSONata reduce expression - syntax error"~~ |
| :white_check_mark: | ~~JOIN node should handle join an array when mode is auto and duplicate indexed parts arrive~~ |
| :white_check_mark: | ~~JOIN node should handle join an array when using msg.parts and duplicate indexed parts arrive and being reset halfway~~ |
| :white_check_mark: | ~~JOIN node should handle msg.parts even if messages are out of order in auto mode if exactly one message has count set~~ |
| :white_check_mark: | ~~JOIN node should handle msg.parts property when mode is auto and parts or id are missing~~ |
| :white_check_mark: | ~~JOIN node should handle too many pending messages for reduce mode~~ |
| :white_check_mark: | ~~JOIN node should join bits of buffer back together automatically~~ |
| :white_check_mark: | ~~JOIN node should join bits of string back together automatically~~ |
| :white_check_mark: | ~~JOIN node should join bits of string back together automatically with a buffer joiner~~ |
| :white_check_mark: | ~~JOIN node should join complete message objects into an array after a count~~ |
| :white_check_mark: | ~~JOIN node should join split strings back into a word~~ |
| :white_check_mark: | ~~JOIN node should join split things back into an array~~ |
| :white_check_mark: | ~~JOIN node should join split things back into an object~~ |
| :white_check_mark: | ~~JOIN node should join split things, send when told complete~~ |
| :white_check_mark: | ~~JOIN node should join strings into a buffer after a count~~ |
| :white_check_mark: | ~~JOIN node should join strings with a specifed character after a timeout~~ |
| :white_check_mark: | ~~JOIN node should join strings with a specifed character and complete when told to~~ |
| :white_check_mark: | ~~JOIN node should join things into an array after a count~~ |
| :white_check_mark: | ~~JOIN node should join things into an array after a count with a buffer join set~~ |
| :white_check_mark: | ~~JOIN node should join things into an array ignoring msg.parts.index in manual mode~~ |
| :white_check_mark: | ~~JOIN node should join things into an array on a sub property in auto mode~~ |
| :white_check_mark: | ~~JOIN node should join things into an object after a count~~ |
| :white_check_mark: | ~~JOIN node should manually join things into an array, send when told complete~~ |
| :white_check_mark: | ~~JOIN node should manually join things into an object, send when told complete~~ |
| :white_check_mark: | ~~JOIN node should merge full msg objects~~ |
| :white_check_mark: | ~~JOIN node should merge objects~~ |
| :white_check_mark: | ~~JOIN node should merge sub property objects~~ |
| :white_check_mark: | ~~JOIN node should reduce messages~~ |
| :white_check_mark: | ~~JOIN node should reduce messages (left)~~ |
| :white_check_mark: | ~~JOIN node should reduce messages (right)~~ |
| :white_check_mark: | ~~JOIN node should reduce messages - count only in last part~~ |
| :white_check_mark: | ~~JOIN node should reduce messages using $I~~ |
| :white_check_mark: | ~~JOIN node should reduce messages with array result~~ |
| :white_check_mark: | ~~JOIN node should reduce messages with fixup~~ |
| :white_check_mark: | ~~JOIN node should reduce messages with flow context~~ |
| :white_check_mark: | ~~JOIN node should reduce messages with global context~~ |
| :white_check_mark: | ~~JOIN node should reduce messages with init types (JSONata)~~ |
| :white_check_mark: | ~~JOIN node should reduce messages with init types (bin)~~ |
| :white_check_mark: | ~~JOIN node should reduce messages with init types (bool)~~ |
| :white_check_mark: | ~~JOIN node should reduce messages with init types (env)~~ |
| :white_check_mark: | ~~JOIN node should reduce messages with init types (flow.name)~~ |
| :white_check_mark: | ~~JOIN node should reduce messages with init types (global.name)~~ |
| :white_check_mark: | ~~JOIN node should reduce messages with init types (json)~~ |
| :white_check_mark: | ~~JOIN node should reduce messages with init types (num)~~ |
| :white_check_mark: | ~~JOIN node should reduce messages with init types (str)~~ |
| :white_check_mark: | ~~JOIN node should reduce messages with persistable flow context~~ |
| :white_check_mark: | ~~JOIN node should reduce messages with persistable global context~~ |
...
| :white_check_mark: | ~~BATCH node mode: interval should create seq. with interval~~ |
...
| Status | Spec Test |
| --- | --- |
| :white_check_mark: | ~~file Nodes file in Node should be loaded~~ |
| :white_check_mark: | ~~file Nodes file in Node should read in a file and output a buffer~~ |
| :white_check_mark: | ~~file Nodes file in Node should read in a file using JSONata and output a utf8 string~~ |
...
| :white_check_mark: | ~~file Nodes file out Node should write to a file using JSONata~~ |
...
| Status | Spec Test |
| --- | --- |
| :white_check_mark: | ~~localfilesystem #clean should clean unnecessary context~~ |
| :white_check_mark: | ~~localfilesystem #clean should not clean active context~~ |
| :white_check_mark: | ~~localfilesystem #delete should delete context~~ |
| :white_check_mark: | ~~localfilesystem #get/set should delete property~~ |
| :white_check_mark: | ~~localfilesystem #get/set should handle empty context file~~ |
| :white_check_mark: | ~~localfilesystem #get/set should not shared context with other scope~~ |
| :white_check_mark: | ~~localfilesystem #get/set should not throw an error when callback of set() is not specified~~ |
| :white_check_mark: | ~~localfilesystem #get/set should set/get multiple values~~ |
| :white_check_mark: | ~~localfilesystem #get/set should set/get multiple values - get unknown~~ |
| :white_check_mark: | ~~localfilesystem #get/set should set/get multiple values - single value providd~~ |
| :white_check_mark: | ~~localfilesystem #get/set should store array~~ |
| :white_check_mark: | ~~localfilesystem #get/set should store array of arrays~~ |
| :white_check_mark: | ~~localfilesystem #get/set should store array of objects~~ |
| :white_check_mark: | ~~localfilesystem #get/set should store boolean~~ |
| :white_check_mark: | ~~localfilesystem #get/set should store local scope property~~ |
| :white_check_mark: | ~~localfilesystem #get/set should store null~~ |
| :white_check_mark: | ~~localfilesystem #get/set should store number~~ |
| :white_check_mark: | ~~localfilesystem #get/set should store object~~ |
| :white_check_mark: | ~~localfilesystem #get/set should store property~~ |
| :white_check_mark: | ~~localfilesystem #get/set should store property - creates parent properties~~ |
| :white_check_mark: | ~~localfilesystem #get/set should store string~~ |
| :white_check_mark: | ~~localfilesystem #get/set should throw an error when callback of get() is not a function~~ |
| :white_check_mark: | ~~localfilesystem #get/set should throw an error when callback of get() is not specified~~ |
| :white_check_mark: | ~~localfilesystem #get/set should throw an error when callback of set() is not a function~~ |
| :white_check_mark: | ~~localfilesystem #get/set should throw an error when getting a value with invalid key~~ |
| :white_check_mark: | ~~localfilesystem #get/set should throw an error when reading corrupt context file~~ |
| :white_check_mark: | ~~localfilesystem #get/set should throw an error when setting a value with invalid key~~ |
| :white_check_mark: | ~~localfilesystem #get/set should throw error if bad key included in multiple keys - get~~ |
| :white_check_mark: | ~~localfilesystem #get/set should throw error if bad key included in multiple keys - set~~ |
| :white_check_mark: | ~~localfilesystem #if cache is enabled should clean unnecessary context in the cache~~ |
| :white_check_mark: | ~~localfilesystem #if cache is enabled should delete context in the cache~~ |
| :white_check_mark: | ~~localfilesystem #if cache is enabled should enumerate context keys in the cache~~ |
| :white_check_mark: | ~~localfilesystem #if cache is enabled should load contexts into the cache~~ |
| :white_check_mark: | ~~localfilesystem #if cache is enabled should store property to the cache~~ |
| :white_check_mark: | ~~localfilesystem #keys should enumerate context keys~~ |
| :white_check_mark: | ~~localfilesystem #keys should enumerate context keys in each scopes~~ |
| :white_check_mark: | ~~localfilesystem #keys should throw an error when callback of keys() is not a function~~ |
| :white_check_mark: | ~~localfilesystem #keys should throw an error when callback of keys() is not specified~~ |
| :white_check_mark: | ~~localfilesystem Configuration should change a base directory~~ |
| :white_check_mark: | ~~localfilesystem Configuration should use HOME_PATH~~ |
| :white_check_mark: | ~~localfilesystem Configuration should use HOME_PATH~~ |
| :white_check_mark: | ~~localfilesystem Configuration should use NODE_RED_HOME~~ |
| :white_check_mark: | ~~localfilesystem Configuration should use userDir~~ |
## util
### @node-red/util/util
| Status | Spec Test |
| --- | --- |
| :white_check_mark: | ~~@node-red/util/util cloneMessage clones a simple message~~ |
| :white_check_mark: | ~~@node-red/util/util cloneMessage does not clone http req/res properties~~ |
| :white_check_mark: | ~~@node-red/util/util cloneMessage handles undefined values without throwing an error~~ |
| :white_check_mark: | ~~@node-red/util/util compareObjects Buffer~~ |
| :white_check_mark: | ~~@node-red/util/util compareObjects arrays~~ |
| :white_check_mark: | ~~@node-red/util/util compareObjects numbers~~ |
| :white_check_mark: | ~~@node-red/util/util compareObjects objects~~ |
| :white_check_mark: | ~~@node-red/util/util compareObjects strings~~ |
| :white_check_mark: | ~~@node-red/util/util encodeObject encode object _req key in msg~~ |
| :white_check_mark: | ~~@node-red/util/util encodeObject encode object _res key in msg~~ |
| :white_check_mark: | ~~@node-red/util/util encodeObject encode object array containing undefined~~ |
| :white_check_mark: | ~~@node-red/util/util encodeObject encode object array of error~~ |
| :white_check_mark: | ~~@node-red/util/util encodeObject encode object array of function~~ |
| :white_check_mark: | ~~@node-red/util/util encodeObject encode object array of number~~ |
| :white_check_mark: | ~~@node-red/util/util encodeObject encode object array of special number~~ |
| :white_check_mark: | ~~@node-red/util/util encodeObject encode object array of string~~ |
| :white_check_mark: | ~~@node-red/util/util encodeObject encode object constructor of Buffer in msg~~ |
| :white_check_mark: | ~~@node-red/util/util encodeObject encode object constructor of IncomingMessage~~ |
| :white_check_mark: | ~~@node-red/util/util encodeObject encode object constructor of ServerResponse~~ |
| :white_check_mark: | ~~@node-red/util/util encodeObject encode object constructor of Socket in msg~~ |
| :white_check_mark: | ~~@node-red/util/util encodeObject encode object long array in msg~~ |
| :white_check_mark: | ~~@node-red/util/util encodeObject encode object object~~ |
| :white_check_mark: | ~~@node-red/util/util encodeObject encode object object which fails to serialise~~ |
| :white_check_mark: | ~~@node-red/util/util encodeObject encode object object which fails to serialise - different error type~~ |
| :white_check_mark: | ~~@node-red/util/util encodeObject encode object object whose name includes error~~ |
| :white_check_mark: | ~~@node-red/util/util encodeObject encode object object with Map property~~ |
| :white_check_mark: | ~~@node-red/util/util encodeObject encode object object with Set property~~ |
| :white_check_mark: | ~~@node-red/util/util encodeObject encode object object with no prototype builtins~~ |
| :white_check_mark: | ~~@node-red/util/util encodeObject encode object object with overriden hasOwnProperty~~ |
| :white_check_mark: | ~~@node-red/util/util encodeObject encode object object with undefined property~~ |
| :white_check_mark: | ~~@node-red/util/util encodeObject encode object test bad object constructor~~ |
| :white_check_mark: | ~~@node-red/util/util encodeObject encode object test bad toString~~ |
| :white_check_mark: | ~~@node-red/util/util encodeObject encode object very large object which fails to serialise should be truncated~~ |
| :white_check_mark: | ~~@node-red/util/util encodeObject encodes 0~~ |
| :white_check_mark: | ~~@node-red/util/util encodeObject encodes Buffer~~ |
| :white_check_mark: | ~~@node-red/util/util encodeObject encodes Error with message~~ |
| :white_check_mark: | ~~@node-red/util/util encodeObject encodes Error without message~~ |
| :white_check_mark: | ~~@node-red/util/util encodeObject encodes Map~~ |
| :white_check_mark: | ~~@node-red/util/util encodeObject encodes Set~~ |
| :white_check_mark: | ~~@node-red/util/util encodeObject encodes boolean~~ |
| :white_check_mark: | ~~@node-red/util/util encodeObject encodes function~~ |
| :white_check_mark: | ~~@node-red/util/util encodeObject encodes null~~ |
| :white_check_mark: | ~~@node-red/util/util encodeObject encodes number~~ |
| :white_check_mark: | ~~@node-red/util/util encodeObject encodes string~~ |
| :white_check_mark: | ~~@node-red/util/util encodeObject encodes undefined~~ |
| :white_check_mark: | ~~@node-red/util/util ensureBuffer Buffers are preserved~~ |
| :white_check_mark: | ~~@node-red/util/util ensureBuffer Object is converted to JSON~~ |
| :white_check_mark: | ~~@node-red/util/util ensureBuffer string is converted~~ |
| :white_check_mark: | ~~@node-red/util/util ensureBuffer stringifies other things~~ |
| :white_check_mark: | ~~@node-red/util/util ensureString Buffer is converted~~ |
| :white_check_mark: | ~~@node-red/util/util ensureString Object is converted to JSON~~ |
| :white_check_mark: | ~~@node-red/util/util ensureString stringifies other things~~ |
| :white_check_mark: | ~~@node-red/util/util ensureString strings are preserved~~ |
| :white_check_mark: | ~~@node-red/util/util evaluateJSONataExpression accesses environment variable from an expression~~ |
| :white_check_mark: | ~~@node-red/util/util evaluateJSONataExpression accesses flow context from an expression~~ |
| :white_check_mark: | ~~@node-red/util/util evaluateJSONataExpression accesses moment from an expression~~ |
| :white_check_mark: | ~~@node-red/util/util evaluateJSONataExpression accesses moment-timezone from an expression~~ |
| :white_check_mark: | ~~@node-red/util/util evaluateJSONataExpression accesses undefined environment variable from an expression~~ |
| :white_check_mark: | ~~@node-red/util/util evaluateJSONataExpression callbacks with error when invalid expression was specified~~ |
| :white_check_mark: | ~~@node-red/util/util evaluateJSONataExpression evaluates a legacyMode expression~~ |
| :white_check_mark: | ~~@node-red/util/util evaluateJSONataExpression evaluates an expression~~ |
| :white_check_mark: | ~~@node-red/util/util evaluateJSONataExpression handles async flow context access~~ |
| :white_check_mark: | ~~@node-red/util/util evaluateJSONataExpression handles async global context access~~ |
| :white_check_mark: | ~~@node-red/util/util evaluateJSONataExpression handles non-existant flow context variable~~ |
| :white_check_mark: | ~~@node-red/util/util evaluateJSONataExpression handles non-existant global context variable~~ |
| :white_check_mark: | ~~@node-red/util/util evaluateJSONataExpression handles persistable store in flow context access~~ |
| :white_check_mark: | ~~@node-red/util/util evaluateJSONataExpression handles persistable store in global context access~~ |
| :white_check_mark: | ~~@node-red/util/util evaluateNodeProperty environment variable returns an environment variable - ${NR_TEST_A~~ |
| :white_check_mark: | ~~@node-red/util/util evaluateNodeProperty environment variable returns an environment variable - ${NR_TEST_A}~~ |
| :white_check_mark: | ~~@node-red/util/util evaluateNodeProperty environment variable returns an environment variable - NR_TEST_A~~ |
| :white_check_mark: | ~~@node-red/util/util evaluateNodeProperty environment variable returns an environment variable - foo${NR_TEST_A}bar~~ |
| :white_check_mark: | ~~@node-red/util/util evaluateNodeProperty environment variable returns an environment variable - foo${NR_TEST_B}bar~~ |
| :white_check_mark: | ~~@node-red/util/util evaluateNodeProperty returns bin~~ |
| :white_check_mark: | ~~@node-red/util/util evaluateNodeProperty returns boolean~~ |
| :white_check_mark: | ~~@node-red/util/util evaluateNodeProperty returns date - default format~~ |
| :white_check_mark: | ~~@node-red/util/util evaluateNodeProperty returns date - iso format~~ |
| :white_check_mark: | ~~@node-red/util/util evaluateNodeProperty returns evaluated json~~ |
| :white_check_mark: | ~~@node-red/util/util evaluateNodeProperty returns flow property~~ |
| :white_check_mark: | ~~@node-red/util/util evaluateNodeProperty returns global property~~ |
| :white_check_mark: | ~~@node-red/util/util evaluateNodeProperty returns jsonata result~~ |
| :white_check_mark: | ~~@node-red/util/util evaluateNodeProperty returns msg property~~ |
| :white_check_mark: | ~~@node-red/util/util evaluateNodeProperty returns null~~ |
| :white_check_mark: | ~~@node-red/util/util evaluateNodeProperty returns number~~ |
| :white_check_mark: | ~~@node-red/util/util evaluateNodeProperty returns regex~~ |
| :white_check_mark: | ~~@node-red/util/util evaluateNodeProperty returns string~~ |
| :white_check_mark: | ~~@node-red/util/util evaluateNodeProperty throws an error if buffer data is not array or string~~ |
| :white_check_mark: | ~~@node-red/util/util evaluateNodeProperty throws an error if callback is not defined~~ |
| :white_check_mark: | ~~@node-red/util/util generateId generates an id~~ |
| :white_check_mark: | ~~@node-red/util/util getMessageProperty retrieves a nested property~~ |
| :white_check_mark: | ~~@node-red/util/util getMessageProperty retrieves a property with array syntax~~ |
| :white_check_mark: | ~~@node-red/util/util getMessageProperty retrieves a simple property~~ |
| :white_check_mark: | ~~@node-red/util/util getMessageProperty should return undefined if property does not exist~~ |
| :white_check_mark: | ~~@node-red/util/util getMessageProperty should throw error if property parent does not exist~~ |
| :white_check_mark: | ~~@node-red/util/util getObjectProperty gets a property beginning with "msg."~~ |
| :white_check_mark: | ~~@node-red/util/util normaliseNodeTypeName pass  ab1~~ |
| :white_check_mark: | ~~@node-red/util/util normaliseNodeTypeName pass AB1~~ |
| :white_check_mark: | ~~@node-red/util/util normaliseNodeTypeName pass HttpRequest~~ |
| :white_check_mark: | ~~@node-red/util/util normaliseNodeTypeName pass _a_b_1_~~ |
| :white_check_mark: | ~~@node-red/util/util normaliseNodeTypeName pass a b 1~~ |
| :white_check_mark: | ~~@node-red/util/util normaliseNodeTypeName pass a-b-1~~ |
| :white_check_mark: | ~~@node-red/util/util normaliseNodeTypeName pass ab1~~ |
| :white_check_mark: | ~~@node-red/util/util normaliseNodeTypeName pass blank~~ |
| :white_check_mark: | ~~@node-red/util/util normaliseNodeTypeName pass http request~~ |
| :white_check_mark: | ~~@node-red/util/util normalisePropertyExpression fail  a.b~~ |
| :white_check_mark: | ~~@node-red/util/util normalisePropertyExpression fail 'a.b'c~~ |
| :white_check_mark: | ~~@node-red/util/util normalisePropertyExpression fail .a~~ |
| :white_check_mark: | ~~@node-red/util/util normalisePropertyExpression fail <blank>~~ |
| :white_check_mark: | ~~@node-red/util/util normalisePropertyExpression fail [0]~~ |
| :white_check_mark: | ~~@node-red/util/util normalisePropertyExpression fail a'b'.c~~ |
| :white_check_mark: | ~~@node-red/util/util normalisePropertyExpression fail a.~~ |
| :white_check_mark: | ~~@node-red/util/util normalisePropertyExpression fail a. b~~ |
| :white_check_mark: | ~~@node-red/util/util normalisePropertyExpression fail a.[0]~~ |
| :white_check_mark: | ~~@node-red/util/util normalisePropertyExpression fail a[~~ |
| :white_check_mark: | ~~@node-red/util/util normalisePropertyExpression fail a['~~ |
| :white_check_mark: | ~~@node-red/util/util normalisePropertyExpression fail a['']~~ |
| :white_check_mark: | ~~@node-red/util/util normalisePropertyExpression fail a[']~~ |
...
| :white_check_mark: | ~~@node-red/util/util normalisePropertyExpression fail a[0~~ |
| :white_check_mark: | ~~@node-red/util/util normalisePropertyExpression fail a[0']~~ |
| :white_check_mark: | ~~@node-red/util/util normalisePropertyExpression fail a[0].[1]~~ |
| :white_check_mark: | ~~@node-red/util/util normalisePropertyExpression fail a[0d]~~ |
| :white_check_mark: | ~~@node-red/util/util normalisePropertyExpression fail a[]~~ |
| :white_check_mark: | ~~@node-red/util/util normalisePropertyExpression fail a[b]~~ |
| :white_check_mark: | ~~@node-red/util/util normalisePropertyExpression fail a[msg.[]]~~ |
| :white_check_mark: | ~~@node-red/util/util normalisePropertyExpression fail a[msg.]~~ |
| :white_check_mark: | ~~@node-red/util/util normalisePropertyExpression fail a[msg['af]]~~ |
| :white_check_mark: | ~~@node-red/util/util normalisePropertyExpression fail a[msg[]~~ |
| :white_check_mark: | ~~@node-red/util/util normalisePropertyExpression fail a]~~ |
| :white_check_mark: | ~~@node-red/util/util normalisePropertyExpression fail b[msg.undefined][2] (with message)~~ |
| :white_check_mark: | ~~@node-red/util/util normalisePropertyExpression pass '1.2.3.4'~~ |
| :white_check_mark: | ~~@node-red/util/util normalisePropertyExpression pass 'a.b'.c~~ |
| :white_check_mark: | ~~@node-red/util/util normalisePropertyExpression pass 'a.b'[1]~~ |
| :white_check_mark: | ~~@node-red/util/util normalisePropertyExpression pass a.$b.c~~ |
| :white_check_mark: | ~~@node-red/util/util normalisePropertyExpression pass a.0.c~~ |
| :white_check_mark: | ~~@node-red/util/util normalisePropertyExpression pass a._b.c~~ |
| :white_check_mark: | ~~@node-red/util/util normalisePropertyExpression pass a.b.c~~ |
| :white_check_mark: | ~~@node-red/util/util normalisePropertyExpression pass a.b.c~~ |
| :white_check_mark: | ~~@node-red/util/util normalisePropertyExpression pass a["$b"].c~~ |
| :white_check_mark: | ~~@node-red/util/util normalisePropertyExpression pass a["_b"].c~~ |
| :white_check_mark: | ~~@node-red/util/util normalisePropertyExpression pass a["b"].c~~ |
| :white_check_mark: | ~~@node-red/util/util normalisePropertyExpression pass a["b"]["c"]~~ |
| :white_check_mark: | ~~@node-red/util/util normalisePropertyExpression pass a['a.b[0]'].c~~ |
| :white_check_mark: | ~~@node-red/util/util normalisePropertyExpression pass a['a.b[0]'].c~~ |
| :white_check_mark: | ~~@node-red/util/util normalisePropertyExpression pass a['b'].c~~ |
| :white_check_mark: | ~~@node-red/util/util normalisePropertyExpression pass a[0].c~~ |
| :white_check_mark: | ~~@node-red/util/util normalisePropertyExpression pass a[0][0][0]~~ |
| :white_check_mark: | ~~@node-red/util/util normalisePropertyExpression pass a[msg.b]~~ |
| :white_check_mark: | ~~@node-red/util/util normalisePropertyExpression pass a[msg.b]~~ |
| :white_check_mark: | ~~@node-red/util/util normalisePropertyExpression pass a[msg.b]~~ |
| :white_check_mark: | ~~@node-red/util/util normalisePropertyExpression pass a[msg.c][0]["fred"]~~ |
| :white_check_mark: | ~~@node-red/util/util normalisePropertyExpression pass a[msg['b]"[']]~~ |
| :white_check_mark: | ~~@node-red/util/util normalisePropertyExpression pass a[msg['b][']]~~ |
| :white_check_mark: | ~~@node-red/util/util normalisePropertyExpression pass a[msg[msg.b]]~~ |
| :white_check_mark: | ~~@node-red/util/util normalisePropertyExpression pass b[msg.a][2]~~ |
| :white_check_mark: | ~~@node-red/util/util normalisePropertyExpression pass b[msg.a][2] (with message)~~ |
| :white_check_mark: | ~~@node-red/util/util prepareJSONataExpression prepares a legacyMode expression~~ |
| :white_check_mark: | ~~@node-red/util/util prepareJSONataExpression prepares an expression~~ |
| :white_check_mark: | ~~@node-red/util/util setMessageProperty creates missing array elements - final property~~ |
| :white_check_mark: | ~~@node-red/util/util setMessageProperty creates missing array elements - mid property~~ |
| :white_check_mark: | ~~@node-red/util/util setMessageProperty creates missing array elements - multi-arrays~~ |
| :white_check_mark: | ~~@node-red/util/util setMessageProperty creates missing parent properties by default~~ |
| :white_check_mark: | ~~@node-red/util/util setMessageProperty deletes property if value is undefined~~ |
| :white_check_mark: | ~~@node-red/util/util setMessageProperty deletes property inside array if value is undefined~~ |
| :white_check_mark: | ~~@node-red/util/util setMessageProperty does not create missing array elements - final property~~ |
| :white_check_mark: | ~~@node-red/util/util setMessageProperty does not create missing array elements - mid property~~ |
| :white_check_mark: | ~~@node-red/util/util setMessageProperty does not create missing parent properties~~ |
| :white_check_mark: | ~~@node-red/util/util setMessageProperty does not create missing parent properties if value is undefined~~ |
| :white_check_mark: | ~~@node-red/util/util setMessageProperty does not create missing parent properties of array~~ |
| :white_check_mark: | ~~@node-red/util/util setMessageProperty does not create missing parent properties of boolean~~ |
| :white_check_mark: | ~~@node-red/util/util setMessageProperty does not create missing parent properties of number~~ |
| :white_check_mark: | ~~@node-red/util/util setMessageProperty does not create missing parent properties of string~~ |
| :white_check_mark: | ~~@node-red/util/util setMessageProperty does not set property of existing boolean property~~ |
| :white_check_mark: | ~~@node-red/util/util setMessageProperty does not set property of existing number property~~ |
| :white_check_mark: | ~~@node-red/util/util setMessageProperty does not set property of existing string property~~ |
| :white_check_mark: | ~~@node-red/util/util setMessageProperty handles nested message property references~~ |
| :white_check_mark: | ~~@node-red/util/util setMessageProperty handles nested message property references~~ |
| :white_check_mark: | ~~@node-red/util/util setMessageProperty sets a deep level property~~ |
| :white_check_mark: | ~~@node-red/util/util setMessageProperty sets a property~~ |
| :white_check_mark: | ~~@node-red/util/util setMessageProperty sets a property with array syntax~~ |
| :white_check_mark: | ~~@node-red/util/util setObjectProperty set a property beginning with "msg."~~ |
